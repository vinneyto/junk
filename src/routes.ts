...
import { createWasmSkinningDemo } from './demo/vinneyto-demo/wasm-skinning';
...
routes.set('vinneyto-wasm-webgl2-triangle', createWasmTriangleDemo);
routes.set('vinneyto-wasm-skinning', createWasmSkinningDemo);
